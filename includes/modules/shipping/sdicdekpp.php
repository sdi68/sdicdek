...
class sdicdekpp extends sdicdek
{
	...
	function __construct() {
		...
		$this->code = 'sdicdekpp';
		$this->title = MODULE_SHIPPING_SDICDEKPP_TEXT_TITLE;
		$this->description = MODULE_SHIPPING_SDICDEKPP_TEXT_DESCRIPTION;
		$this->sort_order = MODULE_SHIPPING_SDICDEKPP_SORT_ORDER;
		$this->icon = DIR_WS_ICONS . 'cdek.png';
		$this->tax_class = MODULE_SHIPPING_SDICDEK_TAX_CLASS;
		$this->enabled = ((MODULE_SHIPPING_SDICDEKPP_STATUS == 'True') ? true : false);
